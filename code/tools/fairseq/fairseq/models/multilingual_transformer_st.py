...
@register_model('multitask_transformer_st')
class MultitaskTransformerSTModel(FairseqMultiModel):
    ...
    def build_model(cls, args, task):
        ...
        from fairseq.tasks.translation_n_selftraining import TranslationNSelfTrainingTask
        assert isinstance(task, TranslationNSelfTrainingTask)
        ...
        return MultitaskTransformerSTModel(encoders, decoders)
...
@register_model_architecture('multitask_transformer_st', 'multitask_transformer_st')
